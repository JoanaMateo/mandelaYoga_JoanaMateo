        ...
        <!-- Grid row -->
            <div class="row mt-3">
                ...
                <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                    ...
                    <i class='fas fa-tshirt me-3 text-secondary'></i> MandelaYoga
                    </h6>
                    <p>
                        Tienda online dedicada al mundo del Yoga.
                    </p>
                </div>
                <!-- Grid column -->
                ...
                <!-- Links -->
                    ...
                    <p>
                        <a href="" class="text-reset">Terminar!!!</a>
                    </p>
                    <p>
                ...
                <!-- Links -->
                    ...
                    <p>
                    <a href="index.php?nombPagina=aboutUs"  class="text-reset">Quienes somos</a>
                    </p>
                    <p>
                    <a href="index.php?nombPagina=contacto"  class="text-reset">Contáctanos</a>
                    </p>
                    <p>
                    <a href="index.php?nombPagina=preguntasFrecuentes"  class="text-reset">Preguntas Frecuentes</a>
                    </p>
                    <p>
                        <a href="#poner el enlace a la guia de estilo????OJO"  class="text-reset">Guia de estilo</a>
                    </p>
                </div>
                <!-- Grid column -->
